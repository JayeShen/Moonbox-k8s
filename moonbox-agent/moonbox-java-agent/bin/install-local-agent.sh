...
# package repeater
/Users/shenweiwei/Desktop/software/maven/apache-maven-3.8.1/bin/mvn clean package -Dmaven.test.skip=true -f ../pom.xml || exit_on_err 1 "package repeater failed."
