...
import com.vivo.internet.moonbox.service.agent.util.JsonComparable;
...
public class ReplayServiceImpl implements ReplayService {
    ...
    private void saveSuccessReplay(RepeatModel repeatModel, RecordWrapperEntity record) {
        ...
        if (actual instanceof JSON && expect instanceof JSON) {
            JsonComparable jsonComparable = new JsonComparable();
            Boolean compare = jsonComparable.compare(actual, expect);
            if (compare) {
                // 保存入库
